...
interactions_train_df, interactions_test_df = train_test_split(interactions_full_df,\
                                   stratify=interactions_full_df['personId'], test_size=0.20, \
                                   random_state=42)
...
# print("item_popuarity_df", item_popularity_df.head(10))
...
mydf = pd.DataFrame(sorted(zip(tfidf_feature_names,
